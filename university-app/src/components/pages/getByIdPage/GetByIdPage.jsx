        ...
        <form
          ...
          <div className="form-group">
            <div className="col-auto my-1">
              <label className="mr-sm-2" htmlFor="getByIdForm">Choose method to get data</label>
              <select className="custom-select mr-sm-2" id="id-type" ref="selectedIdType" value={this.state.value}>
            ...
            <div className="form-group">
              ...
              <input type="number" className="form-control" id="id-number" placeholder="1" ref="selectedIdNumber" />
            </div>

            <div className="form-group">
              <button type="submit" className="btn btn-primary">GET IT FROM SERVER</button>
            </div>
          </div>
        </form>

        <div>
          <button className="btn btn-primary" onClick={this.export}>Export to Excel</button>
